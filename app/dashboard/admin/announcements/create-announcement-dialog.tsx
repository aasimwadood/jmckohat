...
export function CreateInstitutionAnnouncementDialog() {
  ...
  const onSubmit = (formData: FormData) => {
    ...
    startTransition(async () => {
      const result = await createAnnouncementAction("institution", formData);
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent>
        <DialogHeader>
          <DialogTitle>Institution-Wide Announcement</DialogTitle>
        </DialogHeader>
