...
import { LeadershipMessages, FacultiesSection, NewsSection } from "./home-interactive";
...
export default async function HomePage() {
  ...
  const [
    ...
    supabase.from("institution_faculties").select("*").order("display_order"),
    supabase.from("portal_quick_stats").select("*").order("display_order"),
    supabase.from("portal_news").select("*").order("published_at", { ascending: false }).limit(4),
    supabase.from("portal_features").select("*").order("display_order"),
  ]);
  ...
  const leaders = [
    ...
    },
    {
      ...
      image: configMap["PrincipalPhotoUrl"],
      ...
      <section className="relative bg-gradient-to-r from-blue-600 to-blue-800 text-white">
        <div className="relative mx-auto max-w-7xl px-4 py-24 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            <h1 className="mb-6 text-white">Welcome to Our Institution</h1>
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50 py-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mb-16 text-center">
            ...
            <h2 className="mb-4 text-gray-900">Why Choose Our Institution</h2>
